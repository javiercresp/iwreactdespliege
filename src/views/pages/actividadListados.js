    ...
    <>
      ...
      <div className="main">
        <div className="container pb-5">
          <h2 className="mt-4">Actividad: componente reutilizable</h2>
          <p>Alterna entre productos y eventos. El formulario cambia segun el tipo seleccionado.</p>
...
export default ActividadListados;
